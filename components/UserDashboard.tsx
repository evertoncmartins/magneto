          ...
          <div className="space-y-6">
             {orders.map((order) => {
               ...
               return (
                 <div 
                    key={order.id} 
                    className={`bg-white rounded-2xl border transition-all duration-500 overflow-hidden ${isExpanded ? 'shadow-2xl border-[#B8860B]/20' : 'border-gray-100 shadow-sm hover:shadow-md'}`}
                 >
