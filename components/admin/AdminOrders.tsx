                ...
                <div className="space-y-4">
                    {filteredOrders.length === 0 ? (
                        ...
                        filteredOrders.map(order => {
                            ...
                            return (
                                <div key={order.id} className={`bg-white rounded-xl border transition-all duration-300 ${isExpanded ? 'shadow-xl border-[#B8860B]/30' : 'border-gray-100 shadow-sm hover:shadow-md'} ${order.deleted ? 'opacity-70 grayscale' : ''}`}>
                                        ...
                                        <div className="flex items-center gap-5 w-full md:w-auto">
                                            ...
                                            <div>
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    {order.deleted && <span className="bg-red-100 text-red-600 text-[9px] px-1.5 py-0.5 rounded font-bold uppercase flex items-center gap-1"><Trash2 size={10}/> Excluído</span>}
                                                </div>
