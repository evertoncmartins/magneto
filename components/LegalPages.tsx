...
import { 
    ...
    AlertTriangle, CheckCircle, Clock, Info, Package, AlertCircle
} from 'lucide-react';
...
const LegalLayout: React.FC<{ title: string; subtitle: string; icon: any; children: React.ReactNode }> = ({ title, subtitle, icon: Icon, children }) => {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-[#1d1d1f] w-full py-20 flex flex-col items-center justify-center text-center px-6">
