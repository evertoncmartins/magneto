        ...
        sections: [
            {
                ...
                fields: [
                    { key: 'description', label: 'Texto Descritivo', type: 'textarea', value: 'Dedicados a transformar registros digitais em presença física, com a qualidade e o respeito que cada memória merece.' }
                ]
            },
            {
                id: 'social',
                title: 'Redes Sociais',
                fields: [
                    { key: 'instagram_url', label: 'Instagram URL', type: 'text', value: 'https://instagram.com' },
                    { key: 'instagram_visible', label: 'Exibir Instagram', type: 'boolean', value: 'true' },
                    { key: 'facebook_url', label: 'Facebook URL', type: 'text', value: 'https://facebook.com' },
                    { key: 'facebook_visible', label: 'Exibir Facebook', type: 'boolean', value: 'true' },
                    { key: 'twitter_url', label: 'Twitter/X URL', type: 'text', value: 'https://twitter.com' },
                    { key: 'twitter_visible', label: 'Exibir Twitter', type: 'boolean', value: 'true' },
                    { key: 'social_order', label: 'Ordem das Redes Sociais', type: 'text', value: 'instagram,facebook,twitter' }
                ]
            }
        ]
    }
